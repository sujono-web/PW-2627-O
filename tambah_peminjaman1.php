...
//AKHIR CEK ANGGOTA =====================================    
    ...
    mysqli_query(
        ...
        (nopinjam,tglpinjam,tglharuskembali,noanggota)
        VALUES
        (
            '$nopinjam',
            '$tglpinjam',
...
while ($a = mysqli_fetch_assoc($qanggota)) {
    ...
    if ($jumlahPinjam >= 3) {
        ...
        <option
            ...
            data-kelas='".htmlspecialchars($a['kelas'], ENT_QUOTES)."'
            disabled
        >
...
$(document).ready(function () {
    ...
    $(document).on("change", ".copybuku", function () {
        ...
        $(this).closest("tr").find(".judul").val(judul);
    ...
    $("#tambahBaris").on("click", function () {
        ...
        <tr>
            ...
            <td>
                <select name="kdcopybuku[]" class="form-control copybuku" required>
            ...
            <td>
                <input type="number" name="jlhpinjam[]" class="form-control" min="1" value="1" value="1" disabled>
            </td>

            <td align="center">
                <button type="button" class="btn btn-danger hapusBaris">
